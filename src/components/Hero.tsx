...
import { FRONTEND_TECH } from "../constants";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button
              onClick={() => {
                window.open("/assets/Oussama_Djebbour_CV.pdf", "_blank");
              }}
              className="flex items-center gap-2 bg-gray-800 hover:bg-gray-700 text-white px-8 py-3 rounded-lg font-medium border border-gray-700 hover:border-gray-600 transform hover:-translate-y-1 transition-all duration-300"
            >
          ...
          <div className="flex items-center justify-center gap-6 pt-8">
            ...
            <a
              href="https://www.linkedin.com/in/oussama-djebbour-87251827a/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transform hover:scale-110 transition-all duration-300"
            >
            ...
            <a
              href="mailto:oussama_djebbour@outlook.com"
              className="text-gray-400 hover:text-white transform hover:scale-110 transition-all duration-300"
            >
        ...
        <div className="absolute bottom-8 left-[calc(50%-1rem)] transform -translate-x-1/2 animate-bounce">
          <a
            href="#about"
